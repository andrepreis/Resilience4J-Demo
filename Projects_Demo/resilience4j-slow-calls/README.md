...
4. Sempre que ocorrer algum tipo lentidão anormal na chamada de *Service2*, o circuito sera aberto e *Service1* retornará o valor mais atual existente no cache.
